...
func (m ModelNo1) Evaluate(securityCode string, result *concurrent.TreeMap[string, Signal]) {
	...
	if s {
		...
		date := snapshot.Date
		result.Put(securityCode, Signal{Code: securityCode,
